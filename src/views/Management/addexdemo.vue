...
<template>
  <div id="" class="editor">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>添加实验项目</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card>
      <div
        slot="header"
        ...
        "
      >
        <el-page-header @back="goBack" content="添加演示项目"> </el-page-header>
        <div>
          <span v-if="true">
...
import {ADDEXDEMO} from "@/network/management";
export default {
  name: "",
  components: {
    Preview,
  ...
  methods: {
    ...
    submit() {
      ...
      if (!valid) return;
      ADDEXDEMO(this.exdemo,true).then(res=>{
